...
type UserGroup struct {
	...
	DefaultTransferEnable int64     `gorm:"column:default_transfer_enable;default:0" json:"default_transfer_enable"` // 默认流量
	DefaultSpeedLimit     *int      `gorm:"column:default_speed_limit" json:"default_speed_limit"`     // 默认速度限制
	DefaultDeviceLimit    *int      `gorm:"column:default_device_limit" json:"default_device_limit"`   // 默认设备数限制
